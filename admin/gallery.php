            ...
            <nav id="sidebar">
               <div class="sidebar_blog_1">
                  <div class="sidebar-header">
                     <div class="">
                        <a href="gallery.php"><img class="logo_icon img-responsive" src="../assets/img/og.png" alt="#" /></a>
                     </div>
                  </div>
...
<a href="createglr.php" class="btn btn-primary mb-3">Add New Gallery</a>
...
<table class="table table-striped" style="width: 950px";>
  ...
  <tbody>
    ...
    <td><img src="../<?php echo $galeri['image']; ?>" width="100"></td>
      ...
      <td>
        <a href="editglr.php?id=<?php echo $galeri['id']; ?>" class="btn btn-warning btn-sm">Edit</a>
        <a href="deleteglr.php?id=<?php echo $galeri['id']; ?>" class="btn btn-danger btn-sm" onclick="return confirm('Are you sure?')">Delete</a>
      </td>
    </tr>
    <?php endwhile; ?>
  </tbody>
