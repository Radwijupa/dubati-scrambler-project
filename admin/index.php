...
<html lang="en">
  ...
  <div class="container">
        ...
        <?php endif; ?>
        <a href="createvent.php" class="btn btn-primary mb-3">Add New Event</a>
                ...
                <?php while ($row = $result->fetch_assoc()): ?>
                    ...
                    <img src="../assets/img/<?php echo $row['image']; ?>" width="100">
                        ...
                        <td>
                            ...
                            <a href="deletevent.php?id=<?= $row['id'] ?>" onclick="return confirm('Delete The Menu?')" class="btn btn-danger btn-sm">Delete</a>
                        </td>
                    </tr>
                <?php endwhile; ?>
            </tbody>
