            ...
            <nav id="sidebar">
               <div class="sidebar_blog_1">
                  <div class="sidebar-header">
                     <div class="">
                        <a href="team.php"><img class="logo_icon img-responsive" src="../assets/img/og.png" alt="#" /></a>
                     </div>
                  </div>
...
<a href="createteam.php" class="btn btn-primary mb-3">Add New Team</a>
...
<table class="table table-striped" style="width: 1000px";>
  ...
  <?php while ($row = mysqli_fetch_assoc($team)): ?>
    <tr>
      ...
      <td>
        <a href="editteam.php?id=<?php echo $row['id']; ?>" class="btn btn-warning btn-sm">Edit</a>
        <a href="deleteteam.php?id=<?php echo $row['id']; ?>" class="btn btn-danger btn-sm" onclick="return confirm('Are you sure?')">Delete</a>
      </td>
    </tr>
    <?php endwhile; ?>
  </tbody>
