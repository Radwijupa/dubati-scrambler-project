            ...
            <nav id="sidebar">
               <div class="sidebar_blog_1">
                  <div class="sidebar-header">
                     <div class="">
                        <a href="dashboard_2.php"><img class="logo_icon img-responsive" src="../assets/img/og.png" alt="#" /></a>
                     </div>
                  </div>
...
<a href="createsps.php" class="btn btn-primary mb-3">Add New Sponsor</a>
...
<td>
<a href="editsps.php?id=<?php echo $row['id']; ?>" class="btn btn-warning btn-sm">Edit</a>
<a href="deletesps.php?id=<?php echo $row['id']; ?>" class="btn btn-danger btn-sm" onclick="return confirm('Are you sure?')">Delete</a>
</td>
</tr>
<?php endwhile; ?>
</tbody>
