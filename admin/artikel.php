...
<html lang="en">
  ...
  <section id="menu" class="menu">
   <a href="createartic.php" class="btn btn-primary mb-3">Add New Article</a>
  ...
  <table class="table table-bordered">
      ...
      <tbody>
        ...
        <tr class="align-middle">
          ...
          <td><?= $row['title'] ?></td>
          <td class="text-center"><img src="upload/<?= $row['image'] ?>" width="100"></td>
          <td class="text-center">
          <a href="editartik.php?id=<?= $row['id'] ?>" class="btn btn-warning btn-sm">Edit</a> 
          <a href="deleteartik.php?id=<?= $row['id'] ?>" class="btn btn-danger btn-sm">Delete</a>          
        </tr>
        <?php endwhile; ?>
            </tbody>
        </table>
